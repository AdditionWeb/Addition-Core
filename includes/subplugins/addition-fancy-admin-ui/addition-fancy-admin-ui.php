...
function fau_login_theme_style() {
  ...
  wp_enqueue_style(
    'fau-login-style',
    plugins_url() . '/addition-core/includes/subplugins/addition-fancy-admin-ui/css/fau_styles_login.css'
	);
...
function fau_admin_bar_theme_style() {
  ...
  wp_enqueue_style(
		'fau-admin-bar-style',
		plugins_url() . '/addition-core/includes/subplugins/addition-fancy-admin-ui/css/fau_styles_adminbar.css'
	);
...
function fau_admin_theme_style() {
  ...
  wp_enqueue_style(
		'fau-admin-style',
		plugins_url() . '/addition-core/includes/subplugins/addition-fancy-admin-ui/css/fau_styles_admin.css'
	);
